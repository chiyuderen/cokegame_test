...
(function(){
    ...
    var QUESTIONS_ASSETS = [
        {src:"data/cQuestion.json",id:"questions"}
    ];
            ...
            if(json instanceof Array){
                ...
                for(var key in json){
                    ...
                    if(typeof value == "string"){
                        var asset = cokecola.AM.getResult(value);
                        if(asset){
                            json[key] = asset;
                        }
                    }else{
    ...
    a.preloadQuestions = function(question){
        var arr;
        if(question instanceof cokecola.Question){
            arr = [question];
    ...
    cokecola.AssetsManager = AssetsManager;
    cokecola.AM = AssetsManager;
