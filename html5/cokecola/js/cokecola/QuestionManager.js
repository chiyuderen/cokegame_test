...
(function(){
    ...
    var p = QustionManager.prototype = new createjs.EventDispatcher();
    ...
    * */
    p.nextQuestion = function(){
        ...
        if(this.currentQuestionIndex % 5 == 0 && !this._restTime){
            ...
            this.play();
            cokecola.AM.startPreLoad();
            return;
        }
        cokecola.AM.stopPreLoad();
    ...
    p.showQuestion = function(index){
        ...
        if(question){
            var param = {};
            var templete = cokecola.AM.getTemplete(question.template);
            if(!templete){
            ...
            this._renderBase = eval("new "+question.template+"(cQuestion,divContentId)");
    ...
    * */
    ...
    cokecola.QustionManager = QustionManager;
}());
