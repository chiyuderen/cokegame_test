...
(function(){
   ...
   var p = MosaicGame.prototype = new createjs.EventDispatcher();
   var s = MosaicGame;
    /**
     * 判定范围
     * @type {number}
     */
    s.RATE = 5;
    cokeQGame.MosaicGame = MosaicGame;
    ...
    p._imagesMouseEventHandler = function(evt){
        ...
        switch(eventType){
            ...
            case "pressup":
                ...
                if((Math.abs(target.x-imageData.tx) < cokeQGame.MosaicGame.RATE) && (Math.abs(target.y-imageData.ty) < cokeQGame.MosaicGame.RATE)){
